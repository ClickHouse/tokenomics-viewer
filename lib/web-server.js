  ...
  async function handleWebRequest(request, response, options) {
    ...
    try {
      ...
      if (url.pathname === "/api/configuration") {
        ...
        if (request.method === "PUT") {
          ...
          try {
            ...
            const report = await buildReportFromSelectedDatabase(options);
      ...
      if (url.pathname === "/api/report") {
        ...
        if (rawDays != null && (from != null || to != null)) {
          sendJson(response, { error: "days cannot be combined with from or to" }, 400);
          return;
        }
        ...
        sendJson(response, dashboard.webTimeline(report, { project, days, from, to }));
