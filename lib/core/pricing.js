...
// Anthropic's fast-mode tariff is model-specific. Opus 5.5, Opus 5, and
// Opus 4.8 currently have a 2x fast-mode input/output tariff.
...
const PRICING_SOURCES = {
  ...
  openaiGpt6Sol: "https://developers.openai.com/api/docs/models/gpt-6-sol",
  openaiGpt6Luna: "https://developers.openai.com/api/docs/models/gpt-6-luna",
  ...
  anthropicOpus55: "https://platform.claude.com/docs/en/about-claude/pricing",
...
const PRICING = {
  openai: {
    models: {
      ...
      "gpt-6-sol": [{
        ...
        prices: {
          short: { input: 2.00, cacheCreate30m: 2.50, cachedInput: 0.20, output: 10.00 },
          long: { input: 4.00, cacheCreate30m: 5.00, cachedInput: 0.40, output: 15.00 },
        },
      }],
      "gpt-6-luna": [{
        from: "2026-09-22T00:00:00.000Z",
        prices: {
          short: { input: 0.10, cacheCreate30m: 0.125, cachedInput: 0.01, output: 0.50 },
          long: { input: 0.20, cacheCreate30m: 0.25, cachedInput: 0.02, output: 0.75 },
        },
      }],
      "gpt-5.5": {
      ...
      // workspace usage exports. These effective rates and their transition
      // are derived from exported credits and token buckets because no public
      // model page lists codex-auto-review.
      "codex-auto-review": [
        {
  ...
  anthropic: {
    models: {
      ...
      "claude-opus-5-5": [{
        from: "2026-09-22T00:00:00.000Z",
        prices: { input: 4.00, cacheCreate5m: 5.00, cacheCreate1h: 8.00, cacheRead: 0.20, output: 20.00 },
      }],
...
function resolveTimedPricingEntry(entry, timestamp) {
  ...
  // A model with a launch-date `from` has no price before its first interval.
  return null;
}
